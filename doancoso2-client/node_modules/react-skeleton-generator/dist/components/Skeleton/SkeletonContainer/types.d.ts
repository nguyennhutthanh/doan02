...
declare type DisplayTypes = 'block' | 'flex' | 'none' | 'inline' | 'inline-block' | 'inline-flex';
declare type AlignItemsTypes = 'flex-start' | 'center' | 'flex-end';
declare type JustifyContentTypes = 'flex-start' | 'center' | 'flex-end' | 'space-between' | 'space-around' | 'space-evenly';
